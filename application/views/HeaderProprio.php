...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('Accueil_proprio/liste_bien')?>">
          <i class="bi bi-question-circle"></i>
          <span>Liste de bien 💸</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo base_url('Accueil_proprio/chiffre_affaire_proprio')?>">
          <i class="bi bi-question-circle"></i>
          <span>Son chiffre d'affaire 🤑</span>
        </a>
      </li>
