...
<body>
    <div class="container">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<?= site_url('Export/export_excel/')?>" method="post">
                                        <button type="submit">Exporter_excel</button>
                                    </form>
                                </td>
                                <td>
                                    <form action="<?= site_url('Export/export_pdf/')?>" method="post">
                                        <button type="submit">Exporter_pdf</button>
                                    </form>
                                </td>
                            </tr>
                        <?php } ?>
        ...
        <button><a href="<?= site_url("Importation_Co/drop_data3")?>">reinitialiser</a></button>
    </div>
</body>
</html>
